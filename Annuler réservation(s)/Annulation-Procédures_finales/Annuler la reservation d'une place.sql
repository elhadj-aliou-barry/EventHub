...
CREATE PROCEDURE Annuler_reservation (
...
Annulation: BEGIN
    ...
    START TRANSACTION;
        ...
        CALL Liberer_place_reservation(p_num_place,p_id_event);
        CALL MAJ_annulation_statistiques(p_id_event, p_type_place);
...
call Annuler_reservation('amine.richard@gmail.com',4,15,'Standard') ;
